...
public class UpdateGenreTest
{
    ...
    [Fact(DisplayName = nameof(UpdatReplacingRelatedCategories))]
    [Trait("Application", "CreateGenre Use Cases")]
    ...
    [Fact(DisplayName = nameof(UpdatetWithoutCategories))]
    [Trait("Application", "CreateGenre Use Cases")]
    private async Task UpdatetWithoutCategories()
    {
        var genreRepoMock = _fixture.GetGenreRepositoryMock();
        var categoryRepoMock = _fixture.GetCategoryRepositoryMock();
        var uowMock = _fixture.GetUnitOfWorkMock();
    ...
    [Fact(DisplayName = nameof(UpdatetWithEmptyCategories))]
    [Trait("Application", "CreateGenre Use Cases")]
    private async Task UpdatetWithEmptyCategories()
    {
        var genreRepoMock = _fixture.GetGenreRepositoryMock();
        var categoryRepoMock = _fixture.GetCategoryRepositoryMock();
        var uowMock = _fixture.GetUnitOfWorkMock();
