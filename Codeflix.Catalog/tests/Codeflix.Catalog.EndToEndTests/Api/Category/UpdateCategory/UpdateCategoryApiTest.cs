...
public class UpdateCategoryApiTest : IDisposable
{
    ...
    public async void UpdateCategory()
    {
        ...
        output!.Data.Id.Should().Be(exampleCategory.Id); //id da categoria inicial
        output.Data.Name.Should().Be(input.Name); //novo nome do input
    ...
    public async void UpdateCategoryOnlyName()
    {
        ...
        output.Data.Name.Should().Be(input.Name); //novo nome
