...
public class UpdateCategoryApiTest : IDisposable
{
    ...
    public async void UpdateCategory()
    {
        ...
        output!.Should().NotBeNull();
        output!.Id.Should().Be(exampleCategory.Id); //id da categoria inicial
        output.Name.Should().Be(input.Name); //novo nome do input
    ...
    public async void UpdateCategoryOnlyName()
    {
        ...
        output.Name.Should().Be(input.Name); //novo nome
